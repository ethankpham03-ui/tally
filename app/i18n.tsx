...
const enCatalog = {
  ...
  storage: {
    ...
    corruptWarning: 'The saved ledger could not be read. Its original contents have been preserved.',
  ...
  toast: {
    ...
    paymentCurrencyUnsupported: 'Only VND subscriptions can be recorded in the VND ledger.',
  ...
  subscriptions: {
    ...
    recordPaymentVndOnly: 'Only VND charges can be recorded automatically',
  ...
  subscriptionForm: {
    ...
    subtitle: 'Choose a verified plan or enter what you actually pay.',
    editTitle: 'Edit subscription',
    editSubtitle: 'Update the plan, cost, or next renewal.',
    serviceName: 'Service name',
    chooseService: 'Choose a service',
    manualService: 'Other service',
    customServiceName: 'Custom service name',
    servicePlaceholder: 'Example: Spotify',
    plan: 'Current plan',
    choosePlan: 'Choose a plan',
    manualPlan: 'Other plan',
    customPlanName: 'Custom plan name',
    planPlaceholder: 'e.g. Personal',
    cost: 'Cost',
    currency: 'Currency',
    verifiedPrice: 'Verified list price',
    sourceWeb: 'Official website',
    sourceAppStore: 'Vietnam App Store',
    openPriceSource: 'Open the official price source',
  ...
  validation: {
    ...
    subscriptionPlan: 'Choose a plan.',
  ...
  categoryPicker: {
    ...
    createCustom: 'Other',
    customTitle: 'Create a custom category',
  ...
  settings: {
    ...
    clearAll: 'Reset active ledger',
    clearAllBody: 'Reset the active ledger. Earlier recovery copies remain in this browser.',
    confirmClearTitle: 'Reset the active ledger?',
    confirmClearBody: 'Accounts, transactions, subscriptions, and budgets in the active ledger will be reset. Export a backup first. Earlier recovery copies remain; remove all copies through your browser’s site-data settings.',
...
const viCatalog = {
  ...
  storage: {
    ...
    readOnly: 'Dữ liệu phiên bản mới, chỉ xem',
    error: 'Không lưu được dữ liệu trên thiết bị',
    corruptWarning: 'Không đọc được dữ liệu đã lưu. Bản gốc được giữ nguyên và chưa bị ghi đè.',
    futureVersionWarning: 'Dữ liệu này thuộc phiên bản Tally mới hơn. Bản gốc được giữ nguyên và chưa bị ghi đè.',
  },
  header: {
    greeting: 'Xin chào',
    context: {
  ...
  toast: {
    ...
    paymentCurrencyUnsupported: 'Tally chỉ có thể tự động ghi phí bằng VND vào sổ chi tiêu.',
  ...
  overview: {
    ...
    incomeShare: 'Chiếm {percent} tổng thu',
  ...
  renewals: {
    ...
    today: 'Hôm nay',
    overdueBy: {
      one: 'Đã quá hạn {count} ngày',
      other: 'Đã quá hạn {count} ngày',
    },
  ...
  subscriptions: {
    ...
    perMonth: '/tháng',
    annualEstimate: 'Ước tính theo năm',
    ...
    recordPaymentVndOnly: 'Chỉ có thể ghi tự động phí bằng VND',
  ...
  subscriptionForm: {
    ...
    subtitle: 'Chọn gói có giá tham khảo hoặc nhập số tiền bạn đang trả.',
    editTitle: 'Sửa gói đăng ký',
    editSubtitle: 'Cập nhật gói, mức phí hoặc ngày gia hạn.',
    serviceName: 'Tên dịch vụ',
    chooseService: 'Chọn dịch vụ',
    manualService: 'Dịch vụ khác',
    customServiceName: 'Tên dịch vụ',
    servicePlaceholder: 'Ví dụ: Spotify',
    plan: 'Gói đang dùng',
    choosePlan: 'Chọn gói',
    manualPlan: 'Gói khác',
    customPlanName: 'Tên gói',
    planPlaceholder: 'Ví dụ: Cá nhân',
    cost: 'Mức phí',
    currency: 'Tiền tệ',
    verifiedPrice: 'Giá tham khảo',
    sourceWeb: 'Trang chính thức',
    sourceAppStore: 'App Store Việt Nam',
    openPriceSource: 'Mở nguồn giá chính thức',
    checkedOn: 'Cập nhật ngày {date}',
    cycle: {
  ...
  validation: {
    ...
    serviceChoice: 'Chọn một dịch vụ.',
    subscriptionPlan: 'Chọn một gói.',
  ...
  categoryPicker: {
    ...
    createCustom: 'Khác',
    customTitle: 'Tạo danh mục riêng',
  ...
  categoryGroups: {
    food: 'Ăn uống',
    housing: 'Nhà ở và hóa đơn',
    transportation: 'Đi lại và xe cộ',
    shopping_personal: 'Mua sắm cá nhân',
    health: 'Sức khỏe và thể chất',
    family: 'Gia đình và thú cưng',
    education: 'Học tập và phát triển',
    leisure: 'Giải trí và sở thích',
    travel: 'Du lịch',
    digital: 'Công nghệ và dịch vụ số',
    finance: 'Tài chính cá nhân',
    work: 'Công việc và kinh doanh',
    giving: 'Quà tặng và dịp đặc biệt',
    other: 'Khác',
  },
  categories: {
    income: 'Thu nhập',
    dining: 'Ăn ngoài',
    groceries: 'Đi chợ và siêu thị',
    cafe: 'Cà phê và trà',
    food_delivery: 'Đồ ăn giao tận nơi',
    street_food: 'Đồ ăn đường phố',
    snacks: 'Ăn vặt và tráng miệng',
    drinks_alcohol: 'Đồ uống và rượu bia',
    ...
    mobile_phone: 'Cước và nạp tiền điện thoại',
    household_supplies: 'Đồ dùng sinh hoạt',
    home_maintenance: 'Sửa chữa và bảo trì nhà',
    furniture_appliances: 'Nội thất và thiết bị gia dụng',
    domestic_help: 'Giúp việc và vệ sinh nhà',
    transport: 'Đi lại khác',
    ride_hailing: 'Taxi và xe công nghệ',
    public_transport: 'Xe buýt, metro và tàu đô thị',
    fuel: 'Xăng dầu',
    ev_charging: 'Sạc xe điện',
    parking_tolls: 'Gửi xe và phí cầu đường',
    vehicle_maintenance: 'Bảo dưỡng và sửa xe',
    ...
    clothing: 'Quần áo',
    footwear: 'Giày dép',
    electronics: 'Điện tử và thiết bị số',
    cosmetics: 'Mỹ phẩm và chăm sóc da',
    personal_care: 'Làm tóc và chăm sóc cá nhân',
    accessories: 'Phụ kiện và trang sức',
    medical: 'Khám và điều trị',
    pharmacy: 'Thuốc và nhà thuốc',
    hospital: 'Bệnh viện',
    dental: 'Nha khoa',
    vision: 'Khám mắt và kính',
    health_insurance: 'Bảo hiểm sức khỏe',
    fitness: 'Phòng tập và thể hình',
    mental_health: 'Sức khỏe tinh thần',
    wellness: 'Spa và chăm sóc cơ thể',
    childcare: 'Trông trẻ',
    ...
    tuition: 'Học phí',
    courses: 'Khóa học và lớp kỹ năng',
    books: 'Sách và học liệu',
    stationery: 'Đồ dùng học tập',
    exam_fees: 'Thi cử và chứng chỉ',
    ...
    gaming: 'Trò chơi',
    live_events: 'Biểu diễn và sự kiện',
    hobbies: 'Sở thích và thủ công',
    sports: 'Thể thao và hoạt động ngoài trời',
    nightlife: 'Karaoke và vui chơi về đêm',
    music: 'Âm nhạc và podcast',
    flights: 'Vé máy bay',
    intercity_transport: 'Tàu và xe đường dài',
    accommodation: 'Khách sạn và chỗ ở',
    tours: 'Tour và điểm tham quan',
    visa: 'Visa và giấy tờ du lịch',
    travel_insurance: 'Bảo hiểm du lịch',
    souvenirs: 'Quà lưu niệm',
    subscriptions: 'Gói đăng ký',
    software: 'Ứng dụng và phần mềm',
    cloud_storage: 'Lưu trữ đám mây',
    domains_hosting: 'Tên miền và lưu trữ web',
    news_media: 'Tin tức và nội dung số',
    online_services: 'Dịch vụ trực tuyến',
    bank_fees: 'Phí ngân hàng',
    credit_card_fees: 'Phí thẻ',
    loan_payment: 'Trả khoản vay',
    interest: 'Tiền lãi và phí trả chậm',
    taxes: 'Thuế',
    fines: 'Tiền phạt',
    savings: 'Tiết kiệm',
    investments: 'Đầu tư',
    ...
    coworking: 'Chỗ làm việc và văn phòng',
    equipment: 'Thiết bị làm việc',
    advertising: 'Quảng cáo',
    logistics: 'Giao hàng và vận chuyển',
    professional_services: 'Dịch vụ chuyên môn',
    business_meals: 'Tiếp khách',
    business_travel: 'Công tác',
    gifts: 'Quà tặng',
    charity: 'Từ thiện',
    religious: 'Tôn giáo và thờ cúng',
    celebrations: 'Lễ kỷ niệm và tiệc',
  ...
  settings: {
    ...
    clearAll: 'Đặt lại sổ hiện tại',
    clearAllBody: 'Đặt lại sổ hiện tại. Các bản phục hồi cũ vẫn còn trong trình duyệt.',
    confirmClearTitle: 'Đặt lại sổ hiện tại?',
    confirmClearBody: 'Nguồn tiền, giao dịch, gói đăng ký và ngân sách trong sổ hiện tại sẽ được đặt lại. Hãy tải bản sao lưu trước. Bản phục hồi cũ vẫn được giữ; muốn xóa tất cả bản sao, hãy xóa dữ liệu trang web trong trình duyệt.',
    confirmClearAction: 'Xóa toàn bộ dữ liệu',
    exportData: 'Tải bản sao lưu',
    exportDataBody: 'Tải tệp sao lưu để lưu lại hoặc chuyển dữ liệu sang trình duyệt khác.',
